$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','Let’s make a cake!','Ahem Ahem!! Since its your 19th Birthday, so lets celebrate it. Sorry i couldnt go to Berhampore. This is all I can do right now. So have the Happiest Birthday and Enjoy the Day!!!');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 3){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','Mix successful!','Now put it into the oven. I know you are a better cook than me but still instructions are mandatory. hihihihihi');
